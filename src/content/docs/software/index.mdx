...
import SoftwareArchitecture from '../../../components/SoftwareArchitecture.astro';
...
Continue to the [Rust installation instructions](/software/quickstart/rust/installation/).
